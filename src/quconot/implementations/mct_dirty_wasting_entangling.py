# Quconot/quconot/implementations/mct_dirty_wasted_entangling.py
#
# Authors:
#  - Adam Glos
# Apply the implementation from (...)
...
class MCTDirtyWastingEntangling(MCTBase):
    ...
    def verify_mct_cases(
        ...
        if max_auxiliary != controls_no - 1:
            ...
            return [MCTDirtyWastingEntangling(controls_no)]  # only one available
