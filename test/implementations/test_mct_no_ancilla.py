...
@pytest.mark.parametrize(
    "controls_no",
    [
        pytest.param(4, marks=pytest.mark.xfail, id="accepted-fail"),
        pytest.param(5, marks=pytest.mark.xfail, id="accepted-fail"),
    ],
)
...
@pytest.mark.parametrize(
    "controls_no", [4, pytest.param(5, marks=pytest.mark.xfail, id="accepted-fail")]
)
