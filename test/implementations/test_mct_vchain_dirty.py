...
from .functions_testing import (
    ...
    generate_circuit_dirty_auxiliary,
    generate_circuit_dirty_relative_auxiliary,
)
...
class Test:
    ...
    def test_circuit_dirty_auxiliary(self):
        for controls_no in controls_no_list:
            ...
            generate_circuit_dirty_auxiliary(unitary_matrix, controls_no, auxiliaries_no)
    ...
    def test_circuit_dirty_relative_auxiliary(self):
        for controls_no in controls_no_list:
            ...
            generate_circuit_dirty_relative_auxiliary(unitary_matrix, controls_no, auxiliaries_no)
...
if __name__ == "__main__":
    ...
    mct.test_circuit_dirty_auxiliary()
    mct.test_circuit_dirty_relative_auxiliary()
